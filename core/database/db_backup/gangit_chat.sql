...
CREATE TABLE `chat` (
  `chat_messageId` int(6) NOT NULL AUTO_INCREMENT,
  `chat_messageContent` char(255) DEFAULT NULL,
  `chat_messageTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `chat_messageAuthorId` int(6) NOT NULL,
  PRIMARY KEY (`chat_messageId`),
  KEY `chat_messageAuthorId` (`chat_messageAuthorId`)

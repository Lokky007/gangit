...
CREATE TABLE `user_status` (
  `user_status_id` int(6) NOT NULL AUTO_INCREMENT,
  `user_status_name` varchar(20) COLLATE utf8_czech_ci NOT NULL,
...
INSERT INTO `user_status` VALUES (1,'registred'),(2,'active'),(3,'banned');
